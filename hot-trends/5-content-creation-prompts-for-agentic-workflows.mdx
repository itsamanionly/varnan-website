---
title: "5 Claude Projects for your Content"
...
*   **Link:** You can pair this Claude Project's outputs with tools like [Writesonic](https://writesonic.com/) to leverage additional real-time search capabilities.
...
*   **Link:** After generating the script with your Claude Project, you can import the text directly into [CapCut](https://www.capcut.com/) to auto-generate visual captions.
...
*   **Link:** Modern teams often scale workflows similar to this Project across multiple employee accounts using tools like [Copy.ai](https://www.copy.ai/).
...
*   **Link:** You can adapt carousel generation templates from specialized resources like [Workwiz](https://workwiz.ai/prompts/linkedin-carousel-creator) to complement this Project.
...
1. **Log into Claude and Access Projects:** Open Claude.ai and look at the left-hand sidebar. Click on the "Projects" icon or tab to navigate to your projects dashboard.
2. **Create a New Project:** Click the "Create Project" button. Give your Project a clear, descriptive name (e.g., "B2B LinkedIn Architect" or "Short-Form Video Scripter") and a brief description so you or your team know its exact purpose.
3. **Set the Custom Instructions:** Inside your new Project dashboard, find the "Custom Instructions" box. This is where you will paste one of the foundational system prompts provided above. These instructions act as the permanent brain and strict rule set for the Project.
4. **Upload Project Knowledge:** On the right side of the Project interface, you will see an "Add Content" section to upload files. Add your brand guidelines, best-performing historical posts, audience personas, or product documentation. Claude will use these documents as context for every output it generates in this workspace.
5. **Start Chatting:** Once your custom instructions and knowledge base files are saved, use the chat box located specifically within that Project. Type in your rough idea or topic, and Claude will generate your content strictly following the engineered constraints you provided.
...
<FAQSection>
  <FAQItem question="What is the most important element of a system prompt?">
  ...
  <FAQItem question="How do these Claude Projects help AI startups?">
    These Projects allow startups to scale their content marketing efforts without hiring massive creative teams. It saves money, streamlines editorial workflows, and ensures a consistent brand voice across all social media channels by locking in the required system prompts.
  </FAQItem>
